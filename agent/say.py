...
T = {
    ...
    "ask_dob": {"en": ["I have more than one {name} on file. Could you give me the date of birth?"],
                "es": ["Tengo más de una ficha a nombre de {name}. ¿Me da la fecha de nacimiento?"],
                "ca": ["Tinc més d’una fitxa a nom de {name}. Em dona la data de naixement?"]},
